# Graph Report - ETA  (2026-09-02)

## Corpus Check
- 452 files · ~2,597,545 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6260 nodes · 15101 edges · 321 communities (227 shown, 89 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 566 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05f0aaa4`
...
- AgentOverlayVisibilityPolicyTest
...
7. `AgentRuntimeWire` - 83 edges
8. `AgentEvent` - 78 edges
9. `AgentBrowserSession` - 69 edges
10. `ReasoningEffort` - 69 edges
...
## Communities (321 total, 89 thin omitted)
...
Cohesion: 0.04
Nodes (26): AgentOverlayVisibilityPolicy, AgentEvent, AssistantBlockDelta, AssistantBlockEnd, AssistantBlockKind, TEXT, THINKING, TOOL_CALL (+18 more)

### Community 7 - "AgentConversationStore.kt"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (25): AgentFileReferenceGateway, Error, InvalidPath, PathNotFound, RootUnavailable, TypeMismatch, UnsupportedDocumentProvider, UnsupportedFileType (+17 more)
...
Cohesion: 0.12
Nodes (12): EtaAssistantOverlayService, EtaScreenContextAttachment, ComposeView, Job, Lifecycle, LifecycleOwner, SavedStateRegistry, SavedStateRegistryOwner (+4 more)

### Community 12 - "AgentAppState.kt"
Cohesion: 0.13
Nodes (30): buildPermissionHealthState(), buildSystemEnhanceState(), buildToolsState(), hasAppListAccess(), isAgentAccessibilityEnabled(), isIgnoringBatteryOptimizations(), isRootAvailable(), Context (+22 more)

### Community 13 - "AssistantManager"
Cohesion: 0.08
Nodes (22): PowerAssistantTarget, ETA, GEMINI, OEM, ModuleConfig, AssistantBinding, assistantBindingFor(), AssistantSelectionAction (+14 more)

### Community 14 - "ChatMessageItem.kt"
Cohesion: 0.11
Nodes (47): AgentMessageBlock(), AgentWorkProcess(), AITypingIndicator(), BrowserPagePreview(), ChatCodeBlock(), chatMarkdownBodyStyle(), chatMarkdownColors(), chatMarkdownDimens() (+39 more)

### Community 15 - "AgentConversationCodec"
Cohesion: 0.17
Nodes (3): AgentConversationCodec, JSONArray, JSONObject

### Community 16 - "AgentChatBody.kt"
Cohesion: 0.11
Nodes (36): AgentChatBody(), AgentChatBottomBar(), AgentChatScaffold(), AgentConversationMessages(), AgentTimelineEntry, BottomFollowLayout, EmptyChatState(), isWorkProcessMessage() (+28 more)

### Community 17 - "EtaVoicePanel.kt"
Cohesion: 0.43
Nodes (13): assistantBaseHeightPx(), AssistantComposer(), AssistantInputBar(), AssistantPanel(), DragHandle(), EtaVoicePanel(), EtaVoicePanelColors, EtaVoiceUiState (+5 more)

### Community 18 - "AgentRuntimeService"
Cohesion: 0.07
Nodes (19): AgentOverlayGlow(), AgentRuntimeService, CompletedRunContext, IncomingHandler, ComposeView, Context, Handler, IBinder (+11 more)
...
Cohesion: 0.14
Nodes (29): AgentAppRoot(), MessageMutationTarget, AppearanceSettingsScreen(), Modifier, MiuixDialogActions(), MiuixScaffoldPage(), Modifier, ToolChip() (+21 more)
...
### Community 24 - "ProviderDao"
Cohesion: 0.07
Nodes (17): Flow, ProviderDao, ProviderWithModelsSeed, ProviderEntity, ProviderModelEntity, ProviderWithModels, EtaBackupDocument, EtaBackupException (+9 more)
...
Cohesion: 0.13
Nodes (12): Conflict, InstalledSkill, SkillInstallConflict, SkillInstallError, SkillInstallResult, ArchiveOperation, RuntimeException, PreparedCandidate (+4 more)

### Community 28 - "SkillIndexService"
Cohesion: 0.14
Nodes (10): SkillCompatibilityResult, SkillIndexEntry, BuiltinSkillAsset, BuiltinSkillAssetStore, T, SkillCompatibilityChecker, SkillIndexService, SkillRegistryEntry (+2 more)
...
Cohesion: 0.15
Nodes (16): toModelEntities(), AnthropicProviderSetting, CustomProviderSetting, OpenAiCompatibleProviderSetting, OpenAiEndpointMode, ProviderSetting, ProviderSourceTypes, ProviderTypes (+8 more)
...
Cohesion: 0.07
Nodes (7): AgentAppState, agentBooleanForUi(), archiveConversationId(), isReadOnlyExternalArchiveConversation(), Job, MessageRevisionImpact, stableArchiveId()
...
### Community 39 - "UserMessageUi"
Cohesion: 0.27
Nodes (5): resolveFinalResultMessageIds(), AgentMessageUi, UserMessageUi, AgentConversationRevisionReducerTest, AgentChatFinalResultTest
...
Cohesion: 0.09
Nodes (11): CustomHeaderFilter, okhttp3, ProviderJson, toDomain(), toEntity(), CustomBody, CustomHeader, CustomHeaderAndBodyTest (+3 more)
...
Cohesion: 0.13
Nodes (8): EtaRecognitionService, ForwardingRecognitionListener, Bundle, ByteArray, Callback, Intent, SpeechRecognizer, RecognitionListener

### Community 45 - "AgentProvider.kt"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (11): AgentRuntimeRunExecutor, Outcome, AgentRuntimeSession, T, State, COMMITTING, RUNNING, TERMINAL (+3 more)

### Community 52 - "SkillPackageInstallerTest"
Cohesion: 0.18
Nodes (5): SkillPackageLimits, Fixture, ByteArray, Fixture, SkillPackageInstallerTest

### Community 53 - "BreenoHooks"
Cohesion: 0.07
Nodes (10): BoundedRunIdSet, BreenoHooks, BreenoStreamRenderer, HistoryInsertResult, ClassLoader, JSONArray, JSONObject, Method (+2 more)

### Community 54 - "AgentChatMessageUi"
Cohesion: 0.12
Nodes (5): AgentRunMessageProjector, AgentChatMessageUi, ThinkingMessageUi, ToolActivityMessageUi, AgentRunMessageProjectorTest
...
### Community 58 - "PermissionHealthScreen.kt"
Cohesion: 0.16
Nodes (21): Modifier, PermissionHealthCard(), PermissionStatusIcon(), statusLabel(), ArrowItem(), color(), Modifier, label() (+13 more)

### Community 59 - "SkillRecoveryJournal.kt"
Cohesion: 0.13
Nodes (28): deletePathTreeWithoutFollowingLinks(), deleteSkillPathWithoutFollowingLinks(), isRecoverableSkillDirectoryTree(), isRegularDirectoryTreeWithoutLinks(), T, prepareSkillInstallerWorkRoot(), SkillMutationLock, completeRecoveredSkillOperations() (+20 more)

### Community 60 - "AppRoute"
Cohesion: 0.07
Nodes (27): AgentNavigator, NavKey, AppearanceSettings, AppRoute, Browser, Chat, DataBackup, Home (+19 more)
...
Cohesion: 0.14
Nodes (5): Discovery, JSONObject, T, ToolList, WireResponse
...
### Community 64 - ".launchConversationRun"
Cohesion: 0.15
Nodes (3): AgentChatHomeUiState, toUi(), Deferred
...
### Community 67 - "MiuixScaffold"
Cohesion: 0.13
Nodes (18): AdaptiveTopAppBar(), Color, Modifier, ScrollBehavior, Modifier, MiuixPageBottomSpacer(), MiuixScaffold(), horizontalCutoutPadding() (+10 more)
...
### Community 71 - "AgentChatModelControls.kt"
Cohesion: 0.15
Nodes (16): AgentContextUsageButton(), AgentModelPickerButton(), Dp, Modifier, ModelBrandMark(), ModelPickerPopupContent(), ModelPickerRow(), ModelProviderGroupHeader() (+8 more)
...
Cohesion: 0.15
Nodes (13): ActiveRunQuery, AgentRuntimeClient, AttachHandler, AttachOutcome, ClientHandler, Completed, CompletedRunsQuery, DrainHandler (+5 more)
...
Cohesion: 0.12
Nodes (24): Context, SpeechRecognizer, SystemSpeechRecognizer, Settings, displayName(), isAgentAccessibilityEnabled(), isEtaAssistantActive(), Color (+16 more)

### Community 85 - "AgentChatUiState.kt"
Cohesion: 0.09
Nodes (16): CapabilityUi, RunTraceMessageUi, SuggestionChipsMessageUi, SystemNoticeCode, EmptyResult, Interrupted, RuntimeFailed, Stopped (+8 more)

### Community 86 - "AgentChatUiState"
Cohesion: 0.18
Nodes (5): AgentConversationRevisionReducer, Boundary, AgentChatUiState, AgentPendingResultRecoveryTest, AgentRuntimeHistoryReducerTest
...
### Community 91 - "ProviderModelsTab.kt"
Cohesion: 0.16
...
Cohesion: 0.19
Nodes (7): AnthropicBlock, AnthropicMessagesProvider, EventResult, JSONArray, JSONObject, providerMessageText(), AgentTokenUsage

### Community 97 - "AgentEvent.kt"
Cohesion: 0.33
Nodes (4): extractResultCode(), ToolFinished, toSafeResultLogFields(), toSafeLogToken()
...
### Community 99 - "McpHttpClient"
Cohesion: 0.34
Nodes (5): AutoCloseable, McpHttpClient, McpServerManager, McpServerSetting, McpProtocolValidationTest
...
### Community 108 - "AgentImageCodec"
Cohesion: 0.23
Nodes (5): AgentImageCodec, Bitmap, ByteArray, Context, Uri

### Community 109 - "AgentExternalArchivePayload"
Cohesion: 0.11
Nodes (6): AgentExternalArchivePayload, AgentExternalArchivePayloadTest, AgentRunArchiveStoreTest, Context, AgentRuntimeRequestConfigResolverTest, XiaoAiHandoffTest

### Community 110 - "SkillRecoveryJournalTest"
Cohesion: 0.33
Nodes (3): moveSkillDirectoryAtomically(), SkillRecoveryRecord, SkillRecoveryJournalTest

### Community 111 - "HookInstallation"
Cohesion: 0.09
Nodes (17): HookInstallation, ColorOsMemoryHooks, Bundle, ClassLoader, ContentProvider, XposedModule, ContextualSearchHooks, ClassLoader (+9 more)
...
### Community 115 - "AgentRuntimeImageTransfer"
Cohesion: 0.23
...
### Community 124 - "BreenoHooks.kt"
Cohesion: 0.06
Nodes (20): AgentAppContext, Context, safeLogType(), ActiveAgentRun, BoundedRetryBudget, breenoRequestDedupKey(), EnqueueResult, ADDED (+12 more)
...
### Community 131 - "AgentPersonalContextTools"
Cohesion: 0.26
...
### Community 133 - "LinuxFileExplorer"
Cohesion: 0.20
...
### Community 142 - "NotificationHistoryRepository"
Cohesion: 0.15
...
### Community 145 - "ColorOsMemoryDatabaseQuery"
Cohesion: 0.13
...
### Community 150 - "AgentChatScrollPolicyTest"
Cohesion: 0.18
...
Cohesion: 0.21
Nodes (5): McpServerEntity, toDomain(), toEntity(), Flow, McpServerDao

### Community 154 - "AgentMemoryRepository"
Cohesion: 0.16
Nodes (7): AgentMemoryMutation, AgentMemoryRepository, Append, Clear, Context, Flow, ReplaceRange

### Community 155 - "FileOutputStream"
Cohesion: 0.28
...
### Community 159 - "ModelProviderDetailScreen.kt"
Cohesion: 0.33
Nodes (10): android, buildUpdatedProvider(), CoroutineScope, Dp, ScrollBehavior, ModelProviderDetailScreen(), ProviderConfigDraft, ProviderConfigTab() (+2 more)
...
### Community 169 - "ProviderComponents.kt"
Cohesion: 0.25
...
### Community 170 - "AgentLocalSkillResourceToolTest"
Cohesion: 0.20
...
### Community 173 - "McpHttpClient.kt"
Cohesion: 0.16
Nodes (11): Callback, IOException, okhttp3, Response, Callback, McpHttpStatusException, McpJsonRpcException, McpProtocolCompatibilityException (+3 more)

### Community 174 - "McpToolDefinition"
Cohesion: 0.20
Nodes (7): McpAuthorizationType, McpProtocolMode, McpToolDefinition, HttpServer, HttpServer, McpRunContextTest, McpEntitiesTest

### Community 175 - "ColorDirectHooks.kt"
Cohesion: 0.27
Nodes (6): ColorDirectHooks, Activity, ClassLoader, Context, Intent, XposedModule

### Community 176 - "AgentImageCodecTest.kt"
Cohesion: 0.23
...
Cohesion: 0.36
Nodes (4): Bundle, Intent, MainActivity, ComponentActivity
...
### Community 184 - "SkillZipImportOutcome"
Cohesion: 0.31
...
### Community 204 - "AppearanceAccentColor"
Cohesion: 0.18
...
### Community 214 - "XiaoAiRunSlot"
Cohesion: 0.17
Nodes (5): Decision, T, XiaoAiRendererSlot, XiaoAiRunSlot, XiaoAiTakeoverPolicy

### Community 215 - "Offset"
Cohesion: 0.39
Nodes (4): NestedScrollConnection, NestedScrollSource, Offset, Velocity

### Community 218 - "AndroidAgentLogger"
Cohesion: 0.14
Nodes (6): AccessibilityEnableResult, AgentAccessibilityKeeper, Context, AndroidAgentLogger, ApplicationInfo, PredictiveBackController
...
### Community 233 - "PendingSkillConflictCapability"
Cohesion: 0.46
...
### Community 244 - "AgentAppTheme.kt"
Cohesion: 0.48
...
### Community 260 - "AgentModelClient"
Cohesion: 0.11
...
### Community 268 - "DaemonTasksDialog.kt"
Cohesion: 0.67
Nodes (4): DaemonTaskUi, daemonMeta(), DaemonTaskRow(), DaemonTasksDialog()

### Community 269 - "EtaScreenContextPhase"
Cohesion: 0.40
...
### Community 278 - ".validateNode"
Cohesion: 0.83
Nodes (3): Invalid, NodeValidation, Valid

### Community 292 - "ToolExecutionDecision"
Cohesion: 0.50
Nodes (3): Allow, Reject, ToolExecutionDecision

### Community 297 - "EtaVoicePhase"
Cohesion: 0.50
...
Cohesion: 0.40
Nodes (5): ColorOS 电源键目标, Eta 原生数字助理, Gemini 与一圈即搜（ColorOS）, 小布与超级小爱, 系统助手入口

### Community 316 - "System assistant and OEM entry points"
Cohesion: 0.40
Nodes (5): Breeno and Super XiaoAI, ColorOS power-button target, Eta as the native digital assistant, Gemini and Circle to Search (ColorOS), System assistant and OEM entry points

### Community 317 - "toolDisplayName"
Cohesion: 0.83
...
## Knowledge Gaps
- **512 isolated node(s):** `skills`, `APPLIED`, `UNAVAILABLE`, `REJECTED`, `ACCEPTED` (+507 more)
...
- **Why does `AgentModelClient` connect `AgentModelClient` to `AgentRuntimeHistoryReducer`, `RootShellDeviceController`, `AgentLocalTools.kt`, `AgentPersonalContextTools`, `AgentStructuredDeviceTools`, `AgentLocalTools`, `AgentConversationStore.kt`, `AgentTraceFormatter`, `EtaAssistantOverlayService`, `AgentAppState.kt`, `AgentConversationCodec`, `AgentRuntimeService`, `ReasoningEffort`, `HookRegistrar`, `PendingSkillConflictCapabilityParserTest`, `AgentRuntimeWire`, `ProviderDao`, `FileOutputStream`, `.collectFromJsonObject`, `AgentPrivateDatabaseTools`, `ProviderSetting`, `AgentAppState`, `RuntimeConfigRepository`, `AgentLocalSkillResourceToolTest`, `AgentProvider.kt`, `McpToolDefinition`, `AgentToolCallValidator`, `BreenoHooks`, `AgentChatMessageUi`, `BreenoRequestImagesTest`, `OpenAiResponsesProvider`, `AgentPersonalDataTools`, `AgentRuntimePolicyTest`, `AgentRuntimePolicy`, `RuntimeRunDao`, `.launchConversationRun`, `JSONObject`, `OpenAiChatCompletionsProvider`, `AgentChatUiState.kt`, `AgentChatUiState`, `AgentImageTools`, `AgentLogger`, `BreenoRequestImages`, `AgentRuntimeRunExecutor.kt`, `AgentModelClientLoopTest`, `AnthropicMessagesProvider`, `XiaoAiImages`, `AgentPromptBuilderTest`, `AgentModelImageEncoder`, `AgentRunCheckpointStoreTest`, `PendingSkillConflictCapability`, `McpToolExecutor`, `AgentImageCodec`, `AgentExternalArchivePayload`, `AgentRuntimeImageTransfer`, `AgentLoop`, `AgentUiHandoffPayload`, `SkillLoader`, `AgentColorOsMemoryTools`, `BreenoHooks.kt`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `AgentAccessibilityService` connect `AgentAccessibilityService` to `.captureScreenshotExcludingOverlays`, `RootShellDeviceController`, `GestureIndicator.kt`, `GestureDispatch`, `AgentAccessibilityService.kt`, `AccessibilityNodeInfo`, `ScrollEventObservationGate`, `PackageWindowVisibility`, `EtaAssistantOverlayService`, `AgentAppState.kt`, `ScrollDirection`, `AgentRuntimeService`, `SettingsScreen.kt`, `.callOnMainSync`, `.validateNode`, `NodeActionResult`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `AndroidAgentLogger` connect `AndroidAgentLogger` to `EtaAssistantOverlayService`, `AgentAppState.kt`, `AgentRuntimeService`, `EtaApp`, `GoogleAppSystemizerInstaller`, `Composable`, `LogThrottle`, `AlpineEnvironmentInstaller`, `DebianEnvironmentInstaller`, `VerifiedArtifact`, `AgentAppViewModel.kt`, `UserTerminalStore`, `LinuxApkAnalysisInstaller`, `AgentLogger`, `AgentRuntimeRunExecutor.kt`, `ConsoleStore`, `AgentAccessibilityService.kt`, `AgentRuntimeImageTransfer`, `LinuxEnvironmentScreen.kt`?**
